...
/* EXPLICATION : la DESTRUCTURATION permet de SIMPLIFIER 
ou de REORGANISER une STRUCTURE DE DONNEE pour la rendre 
PLUS FACILE à UTILISER et à MANIPULER. Dans le code ci-dessus, 
nous pouvons voir que la destructuration est utilisée pour extraire 
les propriétés d'un objet dans des variables séparées, tout en fournissant 
des noms de variables différents. Caractère utile supplémentaire, 
elle peut également être utilisée pour définir des valeurs par défaut 
